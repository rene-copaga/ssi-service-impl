...
public class Asignation extends ModelBase<AsignationDto> {
    ...
    @ManyToOne(optional = false, targetEntity = DetailActivity.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    private DetailActivity detailActivity;

    @ManyToOne(optional = false, targetEntity = Worker.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER)
